...
class UIBaseComponentMeta(ABCMeta):
    ...
    def find_wrapper(component):
        ...
        wrapper_match = UIBaseComponentWrapper

        # Check for a more specific wrapper in the registry

        if component.native_control_type in UIBaseComponentMeta.control_type_to_cls:
            wrapper_match = UIBaseComponentMeta.control_type_to_cls[component.native_control_type]()
